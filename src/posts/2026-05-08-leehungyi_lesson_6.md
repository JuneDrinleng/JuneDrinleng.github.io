...
![image-20260508175410799](./assets/2026-05-08-leehungyi_lesson_6.assets/image-20260508175410799.png)

例如在2023年，有人就首先让大模型输出一类正确的输出，同时也让其产生一堆错误的输出，然后把这些正确的输出和错误的输出用于训练一个error检测器，然后发现这个训练得到的error检测器是能够检测出正确与否的，同时还具有一定的泛化能力

![image-20260508175423525](./assets/2026-05-08-leehungyi_lesson_6.assets/image-20260508175423525.png)
...
![image-20260508175805176](./assets/2026-05-08-leehungyi_lesson_6.assets/image-20260508175805176.png)
...
![image-20260508181004570](./assets/2026-05-08-leehungyi_lesson_6.assets/image-20260508181004570.png)
...
![image-20260508181953990](./assets/2026-05-08-leehungyi_lesson_6.assets/image-20260508181953990.png)

那么受此启发，DoLa这篇文章就认为，可以利用logit lens来实现错误输出的对比。他的先验假设是这样的，通过模型早期层的输出结果，利用logit lens作为错误输出，然后和最终层进行contrast的方式，得到了最后的DoLa输出

![image-20260508182430315](./assets/2026-05-08-leehungyi_lesson_6.assets/image-20260508182430315.png)
...
![image-20260508182650946](./assets/2026-05-08-leehungyi_lesson_6.assets/image-20260508182650946.png)

### 1.4 Instruction Contrastive Decoding (ICD)

直接给模型一个降智的prompt

![image-20260508182909304](./assets/2026-05-08-leehungyi_lesson_6.assets/image-20260508182909304.png)
...
![image-20260508183157563](./assets/2026-05-08-leehungyi_lesson_6.assets/image-20260508183157563.png)
...
![image-20260508184038221](./assets/2026-05-08-leehungyi_lesson_6.assets/image-20260508184038221.png)
...
![image-20260508184422942](./assets/2026-05-08-leehungyi_lesson_6.assets/image-20260508184422942.png)
...
![image-20260508185618651](./assets/2026-05-08-leehungyi_lesson_6.assets/image-20260508185618651.png)
...
![image-20260508190615629](./assets/2026-05-08-leehungyi_lesson_6.assets/image-20260508190615629.png)
...
![image-20260508192634470](./assets/2026-05-08-leehungyi_lesson_6.assets/image-20260508192634470.png)

自我反思的插入指令对模型的区别：

![image-20260508192648201](./assets/2026-05-08-leehungyi_lesson_6.assets/image-20260508192648201.png)

### 2.2 模型的verification到底划算吗

也许相较于直接把算力用于反思，模型直接多生成几种代码也可能更有用呢？或者说，同样算力投资在反思上对准确性的投资真的划算吗？

![image-20260508193001399](./assets/2026-05-08-leehungyi_lesson_6.assets/image-20260508193001399.png)
...
![image-20260508193514248](./assets/2026-05-08-leehungyi_lesson_6.assets/image-20260508193514248.png)
...
![image-20260508193919627](./assets/2026-05-08-leehungyi_lesson_6.assets/image-20260508193919627.png)

然后还要教模型错误修正：

![image-20260508193941274](./assets/2026-05-08-leehungyi_lesson_6.assets/image-20260508193941274.png)

但问题是，直接教模型自我修正可能会又问题，比如说训练的时候没有遇到的错误方案模型就不会修正了

![image-20260508194147704](./assets/2026-05-08-leehungyi_lesson_6.assets/image-20260508194147704.png)

因此在此基础上就是发展出了Reinforcement Learning （RL）的方法

### 3.2 Reinforcement Learning

![image-20260508194315926](./assets/2026-05-08-leehungyi_lesson_6.assets/image-20260508194315926.png)
...
![image-20260508195235065](./assets/2026-05-08-leehungyi_lesson_6.assets/image-20260508195235065.png)

![image-20260508195242837](./assets/2026-05-08-leehungyi_lesson_6.assets/image-20260508195242837.png)

一个想法是觉得，RL做的就是让你从已有的路径中挑出正确路径的概率提升

另一个想法是认为，RL做的是真的开发了新的思路：

![image-20260508195759971](./assets/2026-05-08-leehungyi_lesson_6.assets/image-20260508195759971.png)
