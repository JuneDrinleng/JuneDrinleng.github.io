  ...
  const features = [
    {
      ...
      description: t(
        "番茄工作法计时器，帮助你集中注意力，高效完成任务",
        "Pomodoro timer to help you stay focused and complete tasks efficiently",
      ),
    },
    {
      icon: TrendingUp,
      ...
      description: t(
        "每日打卡记录，追踪进度，养成良好习惯，持续成长",
        "Daily check-ins, track progress, build good habits, continuous growth",
      ),
    },
    {
      icon: Smartphone,
      ...
      description: t(
        "专为移动端设计，随时随地使用，简洁流畅的交互体验",
        "Designed for mobile, use anytime anywhere, clean and smooth interaction",
      ),
    },
  ];
        ...
        <div className="max-w-7xl lg:max-w-none mx-auto px-4 sm:px-6 lg:px-10 py-10 sm:py-16">
          ...
          <div className="max-w-md mx-auto">
            ...
            >
              ...
              <p className="text-sm opacity-60 mb-4 group-hover:opacity-100">
                Google Play
              </p>
